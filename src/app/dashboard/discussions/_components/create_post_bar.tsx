...
const CreatePostBar = () => {
    ...
    return (
        <>
            ...
            <button onClick={HandleClick} className=" flex bg-[#E8F4FC] dark:bg-stone-800 rounded-full mx-5 items-center px-3 py-1 justify-between">
                <div className="flex items-center space-x-2" >
                    ...
                    <p className=" dark:text-white">Tell everyone whats on your mind</p>
                </div>
